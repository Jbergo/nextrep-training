...
La estructura general del repositorio seguirá una organización clara y profesional:
...
### Breve explicación de carpetas

- **assets/**: recursos visuales del proyecto, como imágenes, capturas o logotipos.
- **diagrams/**: diagramas del sistema, como el E/R o diagramas de clases.
- **docs/**: documentación técnica, organizativa y académica del proyecto.
- **sql/**: scripts SQL de creación, inserción y consultas.
- **src/**: código fuente de la aplicación Java.
- **web/**: páginas HTML, estilos CSS y scripts JS de la parte web.